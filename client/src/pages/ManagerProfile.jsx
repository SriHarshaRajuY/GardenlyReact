// client/src/pages/ManagerProfile.jsx
...
export default function ManagerProfile() {
  ...
  const handleSave = async () => {
    try {
      const res = await fetch((import.meta.env.VITE_BACKEND_URL || '').trim() + "/api/user/update", {
        method: "PUT",
        credentials: "include",
      ...
      <div className="max-w-2xl mx-auto px-4">
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="flex justify-between items-start mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-800">Manager Profile</h1>
              <p className="text-gray-600 mt-1">🚚 Delivery Manager</p>
            </div>
            <button
              onClick={() => {
                logout();
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-800">Delivery Manager</p>
                </div>
              </div>
