      ...
      const loadSeller = async () => {
        try {
          const [orderRes, sumRes] = await Promise.all([
            fetch((import.meta.env.VITE_BACKEND_URL || '').trim() + "/api/seller/orders", { credentials: "include" }),
            fetch((import.meta.env.VITE_BACKEND_URL || '').trim() + "/api/seller/summary", { credentials: "include" }),
          ]);
